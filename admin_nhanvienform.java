 ...
 * @author Bui Hoan
 */
public class admin_nhanvienform extends javax.swing.JFrame {

    /**
     * Creates new form admin_nhanvienform
     */
    public admin_nhanvienform() {
        initComponents();
        getConnection();
    ...
    private void themActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_themActionPerformed
        ...
        else if(jTextFieldTENNV.getText().equals(""))
             JOptionPane.showMessageDialog(this,"Ten NV khong duoc trong");
        else if(jTextFieldCHUCVU.getText().equals(""))
            JOptionPane.showMessageDialog(this,"Chuc vu khong duoc trong");
        else if(jTextFieldLUONG.getText().equals(""))
            JOptionPane.showMessageDialog(this,"Luong khong duoc trong");
        else if(jTextFieldNGAYSINH.getText().equals(""))
            JOptionPane.showMessageDialog(this,"Ngay sinh khong duoc trong");
        else if(jTextFieldGIOITINH.getText().equals(""))
            JOptionPane.showMessageDialog(this,"Gioi tinh khong duoc trong");
        else if(jTextFieldCHUTHICH.getText().equals(""))
    ...
    private void suaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_suaActionPerformed
        ...
        else
        {
            ...
            // Tạo một đối tượng để thực hiện công việc
            st = (Statement) con.createStatement();
            String query = "UPDATE NhanVien SET TENNV='" + jTextFieldTENNV.getText() + "',CHUCVU='" + jTextFieldCHUCVU.getText() + "'"
                    + ",LUONGNV='" + jTextFieldLUONG.getText() + "',NGAYSINH='" + jTextFieldNGAYSINH.getText() + "'"
                    + ",GIOITINH='" + jTextFieldGIOITINH.getText() + "',CHUTHICH='" + jTextFieldCHUTHICH.getText() + "'"
                    + " WHERE MANV='" + jTextFieldMANV.getText() + "'";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(admin_nhanvienform.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new admin_nhanvienform().setVisible(true);
            }
        });
    }
