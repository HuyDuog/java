 ...
 * @author Bui Hoan
 */
public class admin_hoadonform extends javax.swing.JFrame {

    /**
     * Creates new form admin_hoadonform
     */
    public admin_hoadonform() {
        initComponents();
        getConnection();
    ...
    private void them4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_them4ActionPerformed
        // TODO add your handling code here:
        Connection con = getConnection();
        if(jTextFieldMAHD.getText().equals(""))
            JOptionPane.showMessageDialog(this,"Ma HD khong duoc trong");
        else if(jTextFieldMANVHD.getText().equals(""))
            JOptionPane.showMessageDialog(this,"Ma NV khong duoc trong");
        else if(jTextFieldMAPHONGHD.getText().equals(""))
            JOptionPane.showMessageDialog(this,"Ma Phong khong duoc trong");
        else if(jTextFieldNGAY.getText().equals(""))
            JOptionPane.showMessageDialog(this,"Ngay khong duoc trong");
        else if(jTextFieldGIAHD.getText().equals(""))
            JOptionPane.showMessageDialog(this,"Gia HD khong duoc trong");
        else
        {
            try {
    ...
    private void sua4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_sua4ActionPerformed
        ...
        else
        {
            ...
            // Tạo một đối tượng để thực hiện công việc
            st = (Statement) con.createStatement();
            String query = "UPDATE hoadon SET MANV='" + jTextFieldMANVHD.getText() + "',MAPHONG="
                    + "'" + jTextFieldMAPHONGHD.getText() + "',NGAY= '" + jTextFieldNGAY.getText() + "', GIAHD='" + jTextFieldGIAHD.getText() + "'"
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(admin_hoadonform.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new admin_hoadonform().setVisible(false);
            }
        });
    }
