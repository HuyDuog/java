 ...
 * @author Bui Hoan
 */
public class admin_khachhangform extends javax.swing.JFrame {

    /**
     * Creates new form admin_khachhangform
     */
    public admin_khachhangform() {
        initComponents();
        getConnection();
    ...
    private void them1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_them1ActionPerformed
        ...
        Connection con = getConnection();
         if(jTextFieldMAKH.getText().equals(""))
            JOptionPane.showMessageDialog(this,"Ma KH khong duoc trong");
        else if(jTextFieldTENKH.getText().equals(""))
            JOptionPane.showMessageDialog(this,"Ten KH khong duoc trong");
        else if(jTextFieldCMND.getText().equals(""))
            JOptionPane.showMessageDialog(this,"CMND khong duoc trong");
        else if(jTextFieldQUOCTICH.getText().equals(""))
            JOptionPane.showMessageDialog(this,"Quoc Tich khong duoc trong");
        else if(jTextFieldGIOITINHKH.getText().equals(""))
             JOptionPane.showMessageDialog(this,"Gioi tinh khong duoc trong");
        else if(jTextFieldTUOI.getText().equals(""))
            JOptionPane.showMessageDialog(this,"Tuoi khong duoc trong");
        else if(jTextFieldSDT.getText().equals(""))
            JOptionPane.showMessageDialog(this,"SDT khong duoc trong");
        else if(jTextFieldMAPHONGKH.getText().equals(""))
    ...
    private void sua1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_sua1ActionPerformed
         ...
         else
        {
            ...
            // Tạo một đối tượng để thực hiện công việc
            st = (Statement) con.createStatement();
            String query = "UPDATE khachhang SET TENKH='" + jTextFieldTENKH.getText() + "', CMND='" + jTextFieldCMND.getText() + "',QUOCTICH="
                    + " '" + jTextFieldQUOCTICH.getText() + "', GIOITINH='" + jTextFieldGIOITINHKH.getText() + "',TUOI= '" + jTextFieldTUOI.getText() + "',SDT="
                    + " '" + jTextFieldSDT.getText() + "',MAPHONG= '" + jTextFieldMAPHONGKH.getText() + "' WHERE MAKH='" + jTextFieldMAKH.getText() + "'";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(admin_khachhangform.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new admin_khachhangform().setVisible(true);
            }
        });
    }
