 ...
 * @author Bui Hoan
 */
public class admin_phongform extends javax.swing.JFrame {

    /**
     * Creates new form admin_phongform
     */
    public admin_phongform() {
        initComponents();
        getConnection();
    ...
    private void them3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_them3ActionPerformed
        ...
        if(jTextFieldMAPHONG.getText().equals(""))
            JOptionPane.showMessageDialog(this,"Ma phong khong duoc trong");
        else if(jTextFieldTENPHONG.getText().equals(""))
            JOptionPane.showMessageDialog(this,"Ten phong khong duoc trong");
        else if(jTextFieldLOAIPHONG.getText().equals(""))
            JOptionPane.showMessageDialog(this,"Loai phong khong duoc trong");
        else if(jTextFieldGIAPHONG.getText().equals(""))
            JOptionPane.showMessageDialog(this,"Gia phong khong duoc trong");
        else if(jTextFieldCHUTHICHP.getText().equals(""))
            JOptionPane.showMessageDialog(this,"Chu thich khong duoc trong");
        else if(jTextFieldTINHTRANG.getText().equals(""))
            JOptionPane.showMessageDialog(this,"Tinh trang khong duoc trong");
        else if(jTextFieldMANVP.getText().equals(""))
            JOptionPane.showMessageDialog(this,"Ma NV khong duoc trong");
        else if(jTextFieldMADVP.getText().equals(""))
    ...
    private void sua3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_sua3ActionPerformed
        ...
        else
        {
            ...
            // Tạo một đối tượng để thực hiện công việc
            st = (Statement) con.createStatement();
            String query = "UPDATE phong SET TENPHONG='" + jTextFieldTENPHONG.getText() + "',LOAIPHONG='" + jTextFieldLOAIPHONG.getText() + "'"
                    + ",GIAPHONG= '" + jTextFieldGIAPHONG.getText() + "',CHUTHICH= '" + jTextFieldCHUTHICHP.getText() + "'"
                    + ",TINHTRANG= '" + jTextFieldTINHTRANG.getText() + "',MANV= '" + jTextFieldMANVP.getText() + "'"
                    + ",MADV= '" + jTextFieldMADVP.getText() + "' WHERE MAPHONG= '" + jTextFieldMAPHONG.getText() + "'";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(admin_phongform.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new admin_phongform().setVisible(true);
