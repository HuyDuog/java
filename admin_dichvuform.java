 ...
 * @author Bui Hoan
 */
public class admin_dichvuform extends javax.swing.JFrame {

    /**
     * Creates new form admin_dichvuform
     */
    public admin_dichvuform() {
        initComponents();
        getConnection();
    ...
    private void them2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_them2ActionPerformed
        ...
        else if(jTextFieldTENDV.getText().equals(""))
             JOptionPane.showMessageDialog(this,"Ten DV khong duoc trong");
        else if(jTextFieldGIADV.getText().equals(""))
            JOptionPane.showMessageDialog(this,"Gia DV khong duoc trong");
        else
        {
            try {
    ...
    private void sua2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_sua2ActionPerformed
        ...
        else
        {
            try{
            st = (Statement) con.createStatement();
            String query = "UPDATE dichvu SET TENDV="
            + "'" + jTextFieldTENDV.getText() + "', GIADV='" + jTextFieldGIADV.getText() + "'  WHERE MADV='" + jTextFieldMADV.getText() + "'";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(admin_dichvuform.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new admin_dichvuform().setVisible(true);
            }
        });
    }
